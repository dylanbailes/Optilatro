...
class TestMPObsExtension:
    ...
    def test_opponent_lives_in_obs(self):
        ...
        p1_obs = env.p1.encode_obs()
        assert p1_obs[481] == 1.0      # P1 own lives full
        assert p1_obs[482] == 0.75     # P2 lives at 3/4
