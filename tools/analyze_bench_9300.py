"""tools/analyze_bench_9300.py — Deep telemetry analysis for pristine seeds 9300-9599 benchmark.
"""
...
def main():
    json_path = Path("vendor/balatro-rl/results/bench_9300_9599_search_shop_v10.json")
    ...
    print("=" * 80)
    print("BENCHMARK TELEMETRY ANALYSIS: SEEDS 9300-9599 (search_shop_v10)")
    print("=" * 80)
